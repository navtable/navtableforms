...
public class AlphanumericTableModel extends BaseTableModel {
    ...
    private static final Logger logger = Logger.getLogger(AlphanumericTableModel.class);

    private final IEditableSource source;
    private final TableController tableController;
    private final I18nResourceManager i18nManager;

    public AlphanumericTableModel(IEditableSource source, String[] colNames, String[] colAliases,
    ...
    public AlphanumericTableModel(IEditableSource source, String[] colNames, String[] colAliases, IRowFilter filter) {
        super(colNames, colAliases, filter);
        this.i18nManager = new I18nResourceManager(new I18nResource[0]);
        this.source = source;
        this.tableController = new TableController(source);
        initMetadata();
    }
    ...
    public Object getValueAt(int row, int col) {
        try {
            ...
            if ((type == java.sql.Types.BOOLEAN) || (type == java.sql.Types.BIT)) {
                ...
                value = (value.length() == 0) ? i18nManager.getString("table_null_value", value) : i18nManager
                        .getString("table_" + value + "_value", value);
            }
            return value;
    ...
    public void delete(int row) throws StopWriterVisitorException, StartWriterVisitorException,
    InitializeWriterException, ReadDriverException {
