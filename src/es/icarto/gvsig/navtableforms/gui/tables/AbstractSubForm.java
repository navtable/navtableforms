...
public abstract class AbstractSubForm extends JPanel implements IForm,
    ...
    private FillHandler fillFactory;
	...
	fillFactory.fillEmptyWidgetsAndController();
	...
	// removeListeners();
	// TODO: Check that there are not changes
	// super.windowClosed();
    }
...
//	    if (jRootPane != null) {
//		jRootPane.setDefaultButton(saveButton);
//	    }
//	}
    }
    ...
    // private boolean askForDeleting() {
	...
	fillFactory = new FillHandler(widgets, iController,
