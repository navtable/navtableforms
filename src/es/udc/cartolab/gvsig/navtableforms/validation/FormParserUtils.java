...
public class FormParserUtils {
	...
	public static Vector<JComponent> getTBsFromContainerRecursive(Container c, int level){
		...
		while (c.getComponentCount() > count) {
			...
			if (aux instanceof Container) {
				Vector<JComponent> aux2 = getTBsFromContainerRecursive((Container)aux, (level + 1));
	...
	private static Vector<JComponent> getFTFsFromContainerRecursive(Container c, int level){
		...
		while (c.getComponentCount() > count) {
			...
			if (aux instanceof Container) {
				Vector<JComponent> aux2 = getFTFsFromContainerRecursive((Container)aux, (level + 1));
				if ((aux2 != null) && (aux2.size() > 0)){
					for (int i = 0; i < aux2.size(); i++){
						Object e = aux2.get(i);
						if ((e != null) && (e instanceof JComponent)) {
	...
	public static Vector<JComponent> getWidgetsWithContentFromContainer(Container c) {
		return getWidgetsWithContentFromContainerRecursive(c, 0);
	}

	private static Vector<JComponent> getWidgetsWithContentFromContainerRecursive(Container c, int level){
		...
		while (c.getComponentCount() > count) {
			...
			if (aux instanceof Container) {
				Vector<JComponent> aux2 = getWidgetsWithContentFromContainerRecursive((Container)aux, (level + 1));
				if ((aux2 != null) && (aux2.size() > 0)){
					for (int i = 0; i < aux2.size(); i++){
						Object e = aux2.get(i);
						if ((e != null) && (e instanceof JComponent)) {
	...
	private static Vector<JButton> getBTFromContainerRecursive(Container c, int level){
		...
		while (c.getComponentCount() > count) {
			...
			if (aux instanceof Container) {
				...
				if (!(aux instanceof JScrollBar) && !(aux instanceof JComboBox)) {
					Vector<JButton> aux2 = getBTFromContainerRecursive((Container)aux, (level + 1));
					if ((aux2 != null) && (aux2.size() > 0)){
						for (int i = 0; i < aux2.size(); i++){
							Object e = aux2.get(i);
	 ...
	 */
	@Deprecated public static Vector<JComponent> getWidgetsFromContainer(Container c){
		return getWidgetsFromContainerRecursive(c, 0);
	}

	/*
	 * @deprecated using instead {@link #getWidgetsWithContentRecursive(Container c, int level)}
	 */
	@Deprecated private static Vector<JComponent> getWidgetsFromContainerRecursive(Container c, int level){
		...
		while (c.getComponentCount() > count) {
			...
			//				System.out.println(count + "(" +level+"): "+ aux.getName() + ": " + aux.getClass());
			//			}
			...
			if (aux instanceof Container) {
				if (!(aux instanceof JScrollBar)) {
					Vector<JComponent> aux2 = getWidgetsFromContainerRecursive((Container)aux, (level + 1));
					if ((aux2 != null) && (aux2.size() > 0)){
						for (int i = 0; i < aux2.size(); i++){
							Object e = aux2.get(i);
							if ((e != null) && (e instanceof JComponent)) {
