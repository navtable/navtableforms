...
public class XMLSAXParser extends DefaultHandler{
	...
	private void printData(){
		...
		for (ORMLiteTable ft : getDBO().getTableList().values()){
			System.out.println("Table " + ft.getTableName() + " with CODE " + ft.getTableAlias() + " has PK ");
	...
	public void endElement(String uri, String localName, String qName) throws SAXException {
		...
		if (qName.equalsIgnoreCase("FIELDNAME")){
			...
			switch (tmpType){
			case Types.VARCHAR:
				tmpFieldDescription.setDefaultValue(ValueFactory.createValue(tmpVal));
				break;
			case Types.INTEGER:
				if (tmpVal == ""){
					tmpFieldDescription.setDefaultValue(ValueFactory.createNullValue());
				} else {
					tmpFieldDescription.setDefaultValue(ValueFactory.createValue(Integer.parseInt(tmpVal)));
				}
				break;
			case Types.DOUBLE:
				if (tmpVal == ""){
					...
					tmpFieldDescription.setDefaultValue(ValueFactory.createValue(Double.parseDouble(tmpVal)));
				}
				break;
			case Types.BOOLEAN:
				if (tmpVal == ""){
					...
					tmpFieldDescription.setDefaultValue(ValueFactory.createValue(Boolean.parseBoolean(tmpVal)));
				}
				break;
			case Types.DATE:
				if (tmpVal == ""){
					...
					tmpFieldDescription.setDefaultValue(ValueFactory.createValue(Date.parse(tmpVal)));
				}
				break;
			default:
				tmpFieldDescription.setDefaultValue(ValueFactory.createNullValue());
	...
	//		FonsaguaSAXParser spe = new FonsaguaSAXParser();
	//		String xmlFile = "ArqueoPonte.xml";
	//		spe.getDatabaseObjectFromXML(xmlFile);
	//	}
