...
public class WidgetBasedImageHandler implements ImageHandler, KeyListener,
ActionListener {
    ...
    public WidgetBasedImageHandler(String imgComp, String widgetName,
	    String folderPath, IValidatableForm form) {
