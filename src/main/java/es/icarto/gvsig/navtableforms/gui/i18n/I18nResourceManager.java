...
/**
 * This class stores and manages the multiple i18n resources, traversing all
 * them when a key is required until one provides its translation. Keep in mind
 * that if we have multiple resources, it'll provide the first translation it
 * finds that matches the required key.
 * 
...
public class I18nResourceManager {
	...
	public I18nResourceManager(I18nResource[] resources) {
		this.resources = (resources != null ? new ArrayList<I18nResource>(Arrays.asList(resources))
				: new ArrayList<I18nResource>());
	}
