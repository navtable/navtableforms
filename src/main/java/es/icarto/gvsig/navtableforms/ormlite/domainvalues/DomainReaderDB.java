...
public class DomainReaderDB implements DomainReader {
	...
	private static final Logger logger = LoggerFactory.getLogger(DomainReaderDB.class);
	...
	public DomainValues getDomainValues() {
		if (table != null && columnValue != null) {
			...
			try {
				String[][] values = ds.getTable(table, schema, getFieldColumns(), "", new String[] { columnAlias },
						false);
