...
public class ORMLiteAppDomainTests {
	...
	@Test
	public void isFileParsed() throws ParserConfigurationException, SAXException, IOException {
		XMLSAXParser p = new XMLSAXParser(xmlFile);
		assertTrue(p.getAD() != null);
	}

	@Test
	public void appDomainHasDomainValidators() throws ParserConfigurationException, SAXException, IOException {
		XMLSAXParser p = new XMLSAXParser(xmlFile);
	...
	public void fieldMyCodeHasDomainValidator() {
		assertTrue(ormlite.getAppDomain().getDomainValidatorForComponent("my_code") != null);
	}

	@Test
	public void fieldMyWidgetHasDependency() {
		assertTrue(ormlite.getAppDomain().getDependencyValuesForComponent("my_widget") != null);
	}

	@Test
	public void checkDependencyValuesOfMyWidget() {
		Map<String, List<String>> conditions = ormlite.getAppDomain().getDependencyValuesForComponent("my_widget")
				.getConditions();
	...
	public void fieldMyCodeHasRules() {
		assertTrue(ormlite.getAppDomain().getDomainValidatorForComponent("my_code").getRules() != null);
	}

	@Test
	public void fieldMyCodeHasOneRule() {
		assertTrue(ormlite.getAppDomain().getDomainValidatorForComponent("my_code").getRules().size() == 1);
	}

	@Test
	public void fieldMyCodeHasMandatoryRule() {
		Set<ValidationRule> rules = ormlite.getAppDomain().getDomainValidatorForComponent("my_code").getRules();
	...
	public void fieldMyDoubleHasOneRule() {
		assertTrue(ormlite.getAppDomain().getDomainValidatorForComponent("my_double").getRules().size() == 1);
	}

	@Test
	public void fieldMyDoubleHasDoubleRule() {
		Set<ValidationRule> rules = ormlite.getAppDomain().getDomainValidatorForComponent("my_double").getRules();
		boolean hasRule = false;
		for (ValidationRule rule : rules) {
	...
	public void fieldMyDateHasOneRule() {
		assertTrue(ormlite.getAppDomain().getDomainValidatorForComponent("my_date").getRules().size() == 1);
	}

	@Test
	public void fieldMyDateHasDateRule() {
		Set<ValidationRule> rules = ormlite.getAppDomain().getDomainValidatorForComponent("my_date").getRules();
		boolean hasRule = false;
		for (ValidationRule rule : rules) {
	...
	public void fieldMyDoubleMandatoryHasTwoRules() {
		assertTrue(ormlite.getAppDomain().getDomainValidatorForComponent("my_double_mandatory").getRules().size() == 2);
	}

	@Test
	public void fieldMyDoubleMandatoryHasDoubleAndMandatoryRules() {
		Set<ValidationRule> rules = ormlite.getAppDomain().getDomainValidatorForComponent("my_double_mandatory")
				.getRules();
	...
	public void fieldMyDateMandatoryHasTwoRules() {
		assertTrue(ormlite.getAppDomain().getDomainValidatorForComponent("my_date_mandatory").getRules().size() == 2);
	}

	@Test
	public void fieldMyDateMandatoryHasDoubleAndMandatoryRules() {
		Set<ValidationRule> rules = ormlite.getAppDomain().getDomainValidatorForComponent("my_date_mandatory")
				.getRules();
